package com.sigma.security.exception;
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        if (ase != null) {
            if (ase instanceof UsernameNotFoundException) {
                return handleOAuth2Exception(new MssWebResponseExceptionTranslator.BadRequestException(e.getMessage(), e));
            }
