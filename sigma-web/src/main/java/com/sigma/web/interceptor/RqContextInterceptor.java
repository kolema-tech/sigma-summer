...
import static com.sigma.web.SigmaWebConstants.SIGMA_USER_ID;
import static com.sigma.web.SigmaWebConstants.SIGMA_USER_NAME;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (request instanceof RequestWrapper) {
            ...
            if (StringUtils.hasLength(bodyString)) {
                ...
                ThreadContextHolder.setValue(SIGMA_USER_ID, request.getHeader(SIGMA_USER_ID));
                ThreadContextHolder.setValue(SIGMA_USER_NAME, request.getHeader(SIGMA_USER_NAME));
            }
        }
