...
import com.sigma.generator.entity.ColumnClass;
 ...
 * @author zen peng.
 * @version 1.0
 * date-time: 2018/6/12-18:21
 * desc:
 **/
public class CodeGenerateUtils {

    private final String AUTHOR = "zen peng";
    private final String CURRENT_DATE = "2017/05/03";
    private final String tableName = "message_publisher";
    private final String packageName = "com.evada.pm.process.manage";
    private final String tableAnnotation = "质量问题";
    private final String URL = "jdbc:mysql://localhost:3306/sigma";
